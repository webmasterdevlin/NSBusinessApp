...
var TKListViewDataSourceImpl = (function (_super) {
    ...
    TKListViewDataSourceImpl.prototype.listViewViewForSupplementaryElementOfKindAtIndexPath = function (listView, kind, indexPath) {
        var owner = this._owner.get();
        var cell;
        if (kind === "header" && (owner._headerItemTemplateInternal !== undefined || owner.itemViewLoader !== undefined)) {
...
RadListView = (function (_super) {
    ...
    RadListView.prototype.onGroupTemplateChanged = function (oldValue, newValue) {
        ...
        this.headerItemTemplate = newValue;
        this.clearRealizedCells();
        this.refresh();
    };
    ...
    RadListView.prototype.onGroupingFunctionChanged = function (oldValue, newValue) {
        ...
        if (this.groupingFunction) {
            ...
            if (this.headerItemTemplate) {
                template = this.headerItemTemplate;
            }
            else {
                template = this._defaultGroupTemplate;
            }
            this._headerItemTemplateInternal = template;
        }
        else {
            this._headerItemTemplateInternal = undefined;
        }
        this.clearCellsAndUpdateHeaderFooter();
        this.refresh();
    };
